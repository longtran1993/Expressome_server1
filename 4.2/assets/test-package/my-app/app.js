...
$(function(){
    ...
    $("#joinContest").click(function(){
        ...
        io.socket.post('/chat/contest/join',{contestId: contestId}, function(res){
            console.log("Attempt to join with socket: ");
            console.log(res);
            if(res.status != 'success'){
                alert(res.message);
            } else {
                alert('You have joined into the contest chat right now.');
            }
        });
    });
    ...
    // Send message
    $("#contestchat").click(function(){

        var message = $("#message").val();
        var contestId = $("#contestId").val();

        io.socket.post('/chat/contest/message',{contestId: contestId, message: message}, function(res){
            console.log("Send message: ");
            console.log(res);
            if(res.status != 'success'){
                alert(res.message);
    ...
    // One message
    io.socket.on('hello',function(obj){
